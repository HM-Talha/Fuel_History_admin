...
const GroupTreatment = (props: Props) => {
  ...
  const [chipTextForTreatment, setChipTextForTreatment] = useState(
    "Group Treatments for each patients"
  );
          ...
          >
            <Box sx={{ width: "100%" }}>
              ...
              >
                <Tab
                  onClick={() =>
                    setChipTextForTreatment(
                      "Group Treatments for each patients"
                    )
                  }
                  label={<span>Group Treatment Type</span>}
                />
                <Tab
                  onClick={() =>
                    setChipTextForTreatment(
                      "Individual Treatments for each patients"
                    )
                  }
                  label={<span>Individual Treatment Type</span>}
                />
              </Tabs>
